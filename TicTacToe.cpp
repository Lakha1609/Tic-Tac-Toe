...
using namespace std;
int index1;
char board[9] = {'*','*','*','*','*','*','*','*','*'};// Intially array is intialised to *
...
int user_won()//Checks if the USer has Won
{
    for(int i=0;i<9;i+=3)
    {
...
int minimax(bool flag)// function which implement the minmax algorithm
{
...
int main() 
{
   ...
   cout<<endl<<"1-> Player first 2-> CPU first";
